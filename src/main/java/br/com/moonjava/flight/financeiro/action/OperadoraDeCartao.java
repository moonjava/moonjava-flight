...
import br.com.moonjava.flight.financeiro.Bandeira;
 ...
 * 
 */
public class OperadoraDeCartao implements ReaderFile<Cartao> {

  private final List<Cartao> list;

  public OperadoraDeCartao() {
    this.list = new ArrayList<Cartao>();
  }
  ...
  public void openFile() {
    try {
      input = new Scanner(new File("src/main/resources/operadora_cartao.txt"));
